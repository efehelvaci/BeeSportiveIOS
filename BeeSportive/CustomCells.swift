...
public class MapViewController : UIViewController, TypedRowControllerType, MKMapViewDelegate {
    ...
    lazy var pinView: UIImageView = { [unowned self] in
        let v = UIImageView(frame: CGRectMake(0, 0, 40, 40))
        v.image = UIImage(named: "LocationPin", inBundle: NSBundle(forClass: MapViewController.self), compatibleWithTraitCollection: nil)
